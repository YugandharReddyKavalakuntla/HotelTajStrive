...
function renderCartPage() {
  ...
  if (total === 0) { totals.classList.add("d-none"); return; }
...
/* ------------------------------------------------------------------
   PRINT INVOICE (✨ includes table number ✨)
------------------------------------------------------------------ */
function printInvoice() {
  ...
  document.getElementById("invTableNumber").textContent = table;   // NEW
